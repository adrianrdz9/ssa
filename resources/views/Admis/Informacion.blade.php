      ...
      <div class="row" style="text-align:left;">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="email" name="CPresi" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
            </div>
            <div class="form-group">
                ...
                <input type="email" name="CVice" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
            </div>
            <div class="form-group">
                ...
                <input type="email" name="CCargo3" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
            </div>
        </div>
        <div class="col-md-6">
          <div class="form-group">
              ...
              <input type="email" name="CCargo4" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
          </div>
          <div class="form-group">
              ...
              <input type="email" name="CCargo5" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
          </div>
          <div class="form-group">
              ...
              <input type="email" name="CCargo6" class="form-control" placeholder="Correo" pattern="^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\.[a-zA-Z0-9-]+)*$"/>
          </div>
          <div class="form-group" style="text-align:right;">
              <input type="submit" class="btn btn-primary" value="Actualizar"/>
          </div>
